    ...
    return (
        <div className='container'>
            ...
            <div className="container text-center my-4" style={{ color: props.mode === 'dark' ? 'white' : '#212529' }}>
                ...
                <p><strong>GitHub :</strong><a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="https://github.com/MuhammadAhmed-fe"> Muhammad Ahmed-GitHub</a></p>
